...
/*
 * There are three scenarios, in which LIFModule can be loaded by NEST:
 *
...
mynest::LIFL_IEmodule LIFL_IEmodule_LTX_mod;
#endif
// -- DynModule functions ------------------------------------------------------

mynest::LIFL_IEmodule::LIFL_IEmodule()
{
#ifdef LINKED_MODULE
...
const std::string
mynest::LIFL_IEmodule::name( void ) const
{
  return std::string( "LIFL_IE NEST Module" ); // Return name of the module
}

const std::string
mynest::LIFL_IEmodule::commandstring( void ) const
{
  // Instruct the interpreter to load LIFL_IEmodule-init.sli
  return std::string( "(LIFL_IEmodule-init) run" );
}

//-------------------------------------------------------------------------------------

void
mynest::LIFL_IEmodule::init( SLIInterpreter* i )
{
  /* Register a neuron or device model.
     Give node type as template argument and the name as second argument.
  */
  nest::kernel().model_manager.register_node_model< lifl_psc_exp_ie >(
    "lifl_psc_exp_ie" );
  nest::kernel().model_manager.register_node_model< aeif_psc_exp_peak >(
    "aeif_psc_exp_peak" );
